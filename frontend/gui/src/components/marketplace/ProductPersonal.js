...
class ProductPersonal extends Component {
  deleteProduct = e => {
    ...
    this.props.deleteProduct(id, token, this.props.history);
  };
  ...
  render() {
    ...
    if (this.props.product) {
      var id = this.props.product.user.id;
      var title = this.props.product.title;
      var city = this.props.product.city;
      var content = this.props.product.content;
      var state = this.props.product.state;
      var address = this.props.product.address;
      var first_name = this.props.product.user.first_name;
      var last_name = this.props.product.user.last_name;
      var image1 = this.props.product.image1;
      var image2 = this.props.product.image2;
      var image3 = this.props.product.image3;
      var image4 = this.props.product.image4;
    }
